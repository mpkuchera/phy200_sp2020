...
def plotDensity():
    ...
    print("When both Skips and Dist are optimized, alpha = ", maxA,", beta = ", maxB, ":")
    skip, dist = sk2.skipPlot(maxA,maxB, 0.0, 50.0, 1000)
    print("The stone skips", skip, "times over", dist, "cm.")

    print("When skips is optimized, alpha = ", maxC,", beta = ", maxD, ":")
    skip, dist = sk2.skipPlot(maxC,maxD, 0.0, 50.0, 1000)
    print("The stone skips", skip, "times over", dist, "cm.")
    
    print("When distance is optimized, alpha = ", maxE,", beta = ", maxF, ":")
    skip, dist = sk2.skipPlot(maxE,maxF, 0.0, 50.0, 1000)
    print("The stone skips", skip, "times over", dist, "cm.")
